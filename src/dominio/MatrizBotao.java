...
public class MatrizBotao {
	...
	public MatrizBotao(int tamanho) {
		...
		ney = new ImageIcon("C:\\Users\\alberto\\eclipse-workspace\\Campo_Minado\\src\\arquivo\\Ney.jpg");
	...
	public void reiniciaJogo(MouseListener trataClick) {
		...
		smile.setIcon(new ImageIcon("C:\\Users\\alberto\\eclipse-workspace\\Campo_Minado\\src\\arquivo\\Ney.jpg"));
		janela.setVisible(true);
	}
		...
		MouseListener trataClick = new MouseListener() {
			public void mouseClicked(MouseEvent e) {
				...
				{	
					...
					ImageIcon addIcon = new ImageIcon("C:\\Users\\alberto\\eclipse-workspace\\Campo_Minado\\src\\arquivo\\Galvao.jpg");
					ImageIcon addmina = new ImageIcon("C:\\Users\\alberto\\eclipse-workspace\\Campo_Minado\\src\\arquivo\\BOLA.jpg");

					revelaMinas(this,addmina); // MOSTRA TODAS AS MINAS DO CAMPO
					smile.setIcon(addIcon); // MUDA O ICONE DO "SMILE"
					audio.playSom("C:\\Users\\alberto\\eclipse-workspace\\Campo_Minado\\src\\arquivo\\Gol.wav"); // SOLTA O AUDIO DE GOL DA ALEMANHA
				...
				{					
						...
						if (qtd_bandeiras == 0)
						{
							...
							{
								audio.playSom
								("C:\\Users\\alberto\\eclipse-workspace\\Campo_Minado\\src\\arquivo\\acabou.wav"); // SOLTA AUDIO DE CAMPEÃO
								cronometro.pararCr();
